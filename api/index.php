				...
				<div class="modal fade rtl" id="Help" tabindex="-1" role="dialog" aria-labelledby="Help-label">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body partial-modal">
								<div>
									<p>للمزيد من المعلومات، الرجاء التواصل مع مركز خدمة المتعاملين المتوفر 24 ساعة على 60043216 ( من داخل الإمارات) أو +97126100600 (من خارج الإمارات) حتى نتمكن من مساعدتك. شكراً لك</p>
								</div>
							</div>
						</div>
					</div>
